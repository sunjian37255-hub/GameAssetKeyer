...
if ($sourceNotice -notmatch [regex]::Escape('https://github.com/sunjian37255-hub/GameAssetKeyer/tree/v1.1.1')) {
    $failures.Add('SOURCE.txt does not point to the v1.1.1 corresponding source')
}
